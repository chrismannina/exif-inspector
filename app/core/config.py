...
class Settings(BaseSettings):
    ...
    temp_dir: Path = Field(default=Path("temp_uploads"), description="Directory for temporary files")
    
    # Static file settings
    static_dir: Path = Field(default=BASE_DIR / "frontend" / "static", description="Directory for static files")
